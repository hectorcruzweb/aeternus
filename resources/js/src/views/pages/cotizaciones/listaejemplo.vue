<template>
    <div>
        ...
        <ReportesCotizacion :verAcuse="verAcuse" :show="openReportes" @closeListaReportes="closeListaReportes"
            :id_venta="id_venta"></ReportesCotizacion>
...
import ReportesCotizacion from "@pages/cotizaciones/ReportesCotizacion";
