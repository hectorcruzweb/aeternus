                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-6/12 xl:w-3/12 px-2">
                        <div class="w-full input-text">
                            ...
                            <flat-pickr :disabled="habilitar_rango == 1" name="rango_fechas" data-vv-as=" "
                                :config="configdateTimePickerRange" v-model="rango_fechas"
                                placeholder="Rango de fechas del reporte" class="w-full" @on-close="onCloseDate" />
                        </div>
                    </div>
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-6/12 xl:w-3/12 px-2">
                        <div class="w-full input-text pb-2">
                            <label class="">Empleado</label>
                            <v-select :options="empleados" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                v-model="empleado" class="md:mb-0" />
                        </div>
                    </div>
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-6/12 xl:w-3/12 px-2">
                        <div class="w-full input-text pb-2">
