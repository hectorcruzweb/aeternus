            ...
            try {
                ...
                if (data) {
                    ...
                    if (this.filters.operacion_id) {
                        ...
                        if (match) {
                            this.operacion_descripcion = match.descripcion + ' Saldo: ' + match.saldo;
                        }
                    } else this.operacion_descripcion = "No se seleccionó ninguna operación";
                }
                this.$emit("resultado", true);
            } catch (error) {
                this.$vs.notify({
                    title: "Datos del Cliente",
                    text: "Error al cargar los datos del cliente. Por favor reintente.",
                    iconPack: "feather",
