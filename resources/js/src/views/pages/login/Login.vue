<template>
  <div class="h-screen flex w-full vx-row no-gutter items-center justify-center bg-login-password-recovery">
        ...
        <div slot="no-body" class>
          <div class="vx-row no-gutter justify-center items-center">
            <div class="vx-col hidden lg:block lg:w-1/2">
              <img src="@assets/images/sistemas_aeternus.svg" alt="login" class="mx-auto login-img" />
              <div class="flex flex-wrap">
                <div class="w-full sm:w-12/12 md:w-11/12 lg:w-11/12 xl:w-11/12 mr-auto ml-auto">
                  <h1 class="uppercase color-dark-800 font-medium h3 text-center pt-6">
            ...
            <div class="vx-col sm:w-full md:w-full lg:w-1/2">
              <div class="px-8">
                <div class="flex flex-wrap">
                  <div class="w-full sm:w-12/12 md:w-12/12 lg:w-12/12 xl:w-12/12 mr-auto ml-auto px-2">
                    <div class="">
                      ...
                      <div class="w-full input-text">
                        ...
                        <vs-input v-validate="'required|email|min:3|max:50'" name="email" maxlength="50" icon-no-border
                          data-vv-as=" " icon="icon icon-user" icon-pack="feather" placeholder="Correo electrónico"
                          v-model="email" class="w-full" ref="email" />
                        <span>{{ errors.first("email") }}</span>
                      </div>
                      <div class="w-full input-text">
                        <label class="">Contraseña <span>(*)</span></label>
                        <vs-input v-validate="'required|min:6|max:25'" type="password" name="password" data-vv-as=" "
                          maxlength="25" icon-no-border icon="icon icon-lock" icon-pack="feather"
                          placeholder="Contraseña" v-model="password" class="w-full" v-on:keyup.enter="loginJWT" />
                        <span>{{ errors.first("password") }}</span>
                      </div>

                      <div class="flex flex-wrap justify-between size-small font-light smaller-line pt-2 pb-6">
                ...
                <vs-checkbox v-model="checkbox_remember_me" class="mb-3 hidden">Recordarme</vs-checkbox>
                      ...
                      <div class="flex flex-wrap">
                        <div class="w-full text-center size-normal pt-6">
                          <router-link to="/pages/forgot-password"><span
                              class="color-dark-700 color-primary-hover-900">¿Olvidaste tu
