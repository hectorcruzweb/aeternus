<template>
    <div class="centerx">
        <vs-popup class="forms-popup fullscreen" title="Cancelar Venta en General" :active.sync="showVentana"
            ref="cancelar_venta">
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full xl:w-12/12 pt-6">
                            <div class="flex flex-wrap">
                                <div class="w-full xl:w-4/12 input-text px-2">
                                    ...
                                    <vs-input size="large" v-model="form.cantidad"
                                        v-validate="'required|decimal:2|min_value:0'" name="cantidad" data-vv-as=" "
                                        type="text" class="w-full" placeholder=" $ 00.00 Pesos MXN" maxlength="7" />
                                ...
                                <div class="w-full xl:w-8/12 input-text px-2">
                                    ...
                                    <v-select :options="motivos" :clearable="false" v-model="form.motivo"
                                        ...
                                        v-validate:motivo_computed.immediate="'required'" name="plan_venta"
                                        data-vv-as=" ">
                                        <div slot="no-options">
                        ...
                        <div class="w-full input-text px-2">
                            <label>Agregue un comentario respecto a la cancelación de esta
                                venta:</label>
                            <vs-textarea class="w-full" label="Detalle de la cancelación..." height="150px"
