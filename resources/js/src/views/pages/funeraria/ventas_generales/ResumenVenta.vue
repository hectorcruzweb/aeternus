            ...
            if (parseInt(newValue) != 0) {
                (async () => {
                    ...
                    try {
                        ...
                        for (let index = 0; index < this.datosVenta.conceptos_temporales.length; index++) {
                            const element = this.datosVenta.conceptos_temporales[index];
                            if (element.existencia == 0) {
                                this.$emit("showNoInvetario");
                                break;
                            }
                        }
