    ...
    <vs-popup
      ...
      :title="
        getTipoformulario == 'agregar'
          ? 'ventas de artículos y servicios en general'
          : 'POR DEFINIR FUNCION'
      "
                          ...
                          >
                            ...
                            <vs-td class="">
                              <vs-input
                                ...
                                "
                                :disabled="
                                  form.articulos[indextr].descuento_b == 1
                                "
                              />
                              <div class="input-text">
                                <span>
                            ...
                            <vs-td class="">
                              <vs-input
                                ...
                                "
                                :disabled="
                                  form.articulos[indextr].descuento_b == 0
                                "
                              />
                              <div class="input-text">
                                <span>
                            ...
                            <vs-td class="">
                              <div
                                v-if="form.articulos[indextr].descuento_b == 1"
                              >
                                $
                                {{
