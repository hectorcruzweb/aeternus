<template>
    <div class="centerx">
        <vs-popup :class="['forms-popup popup-85', z_index]" title="Catálogo de proveedores registrados"
            :active.sync="showVentana" ref="buscador_proveedor">
                ...
                <vx-card no-radius title="Filtros de selección" refresh-content-action @refresh="reset"
                    ...
                    <div class="flex flex-wrap pb-6">
                        <div class="w-full input-text xl:w-3/12 px-2">
                            ...
                            <vs-input name="num_proveedor" data-vv-as=" " type="text" class="w-full"
                        ...
                        <div class="w-full input-text xl:w-9/12 px-2">
                            <label>Nombre</label>
                            <vs-input ref="nombre_proveedor" name="nombre_proveedor" data-vv-as=" " type="text"
                                class="w-full" placeholder="Ej. Juan Pérez" maxlength="12"
                ...
                <div class="resultados_proveedores py-6">
                    ...
                    <div>
                        <vs-pagination v-if="verPaginado" :total="this.total" v-model="actual"
                            class="mt-6"></vs-pagination>
                    </div>
                </div>
            </div>
            <FormularioProveedores :tipo="'agregar'" :z_index="'z-index58k'" :show="verFormularioProveedores"
                @closeVentana="verFormularioProveedores = false" @retornar_id="retorno_id"></FormularioProveedores>
            <!--fin de buscador-->
        </vs-popup>
    </div>
</template>
