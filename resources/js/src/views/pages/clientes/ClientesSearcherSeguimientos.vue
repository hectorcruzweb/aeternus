                ...
                <div id="resultados" class="mt-5 flex flex-col flex-1">
                    ...
                    <div v-else id="results" class="w-full flex flex-wrap">
                        <div class="w-full py-2">
                                        ...
                                        <vs-td>
                                            <div class="flex justify-center">
                                                <img class="cursor-pointer img-btn-20 mx-3"
                                                    src="@assets/images/checked.svg" @click="
                                                        $emit(
                            ...
                            <div>
                                <vs-pagination v-if="verPaginado" :total="total" :max="serverOptions.per_page"
                                    v-model="actual" class="mt-6" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        show: {
            ...
            async handler(newVal) {
                ...
                if (newVal) {
                    ...
                    await this.$popupManager.register(this, this.cancelar, null);
                }
