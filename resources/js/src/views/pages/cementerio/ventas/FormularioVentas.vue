            ...
            <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group-content">
                                <div class="flex flex-wrap">
                                    ...
                                    <div
                                        class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text"
                                    >
                                        <label
                                            v-if="
                                                this.datosAreas
                                        ...
                                        <v-select
                                            ...
                                            :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                            v-model="form.filas"
                                            v-validate:fila_validacion_computed.immediate="
                                                'required'
                                            "
                                    ...
                                    <div
                                        class="w-full px-2 size-small color-copy pt-2"
                                    >
                                        <span
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-content">
                        <div class="flex flex-wrap">
                            <div
                                class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text"
                            >
                                <label class="">
                    ...
                    <div class="form-group-content">
                        <div class="flex flex-wrap">
                            <div class="w-full lg:w-6/12 px-2">
                                ...
                                <div class="flex flex-wrap">
                                    <div
                                        class="w-full md:w-6/12 input-text px-2"
                                    >
                                        <label class="">
                                            Número de Pagos
                                            <span>(*)</span>
                                    ...
                                    <div
                                        class="w-full md:w-6/12 px-2 input-text hidden"
                                    >
                                        <label class="">
                                        ...
                                        <vs-input
                                            size="large"
                                            v-validate="
                                                'required|integer|min_value:1|max_value:150'
                                            "
                                    ...
                                    <div class="w-full input-text px-2">
                                        ...
                                        <vs-input
                                            ...
                                            data-vv-as=" "
                                            v-validate="
                                                'required|decimal:2|min_value:1'
                                            "
                                            type="text"
                                            class="w-full"
                                            placeholder=""
                            ...
                            <div class="w-full lg:w-6/12 px-2 lg:mt-16">
                                <div class="flex flex-wrap">
                                    ...
                                    <div
                                        class="w-full px-2 pt-6 text-center mx-auto"
                                    >
                                        <vs-button
                                            v-if="!fueCancelada"
