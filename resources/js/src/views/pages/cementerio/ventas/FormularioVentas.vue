            ...
            <div>
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-6/12 xl:w-6/12 px-4">
                        <!--mapa del cementerio-->
                        <div>
                            <Mapa :disabled="tiene_pagos_realizados ||
                                ventaLiquidada ||
                                fueCancelada
                                " :idAreaInicial="idAreaInicial" @getDatosTipoPropiedad="getDatosTipoPropiedad"
                                @respuestaDeshabilitado="respuestaDeshabilitado"></Mapa>
                        </div>
                    ...
                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 xl:pt-8">
                        ...
                        <div class="form-group">
                            <div class="title-form-group">
                                <span v-if="!this.datosAreas.tipo_propiedades_id">Ubicación y tipo de venta</span>
                            ...
                            <div class="form-group-content">
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <v-select :disabled="tiene_pagos_realizados ||
                                            ventaLiquidada ||
                                            fueCancelada
                                            " :options="filas" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                            v-model="form.filas" v-validate:fila_validacion_computed.immediate="'required'
                                                " name="fila_validacion" data-vv-as=" ">
                                            <div slot="no-options">
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <v-select :options="lotes" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                            v-model="form.lotes" :disabled="this.datosAreas
                                                .tipo_propiedades_id != 4 ||
                                                tiene_pagos_realizados ||
                                                ventaLiquidada ||
                                                fueCancelada
                                                " v-validate:ubicacion_validacion_computed.immediate="'required'
                                                    " name="ubicacion_validacion" data-vv-as=" ">
                                            <div slot="no-options">
                                                Seleccione 1 Área
                                            </div>
                                        </v-select>
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <v-select :disabled="ModificarVenta" :options="ventasAntiguedad"
                                            ...
                                            v-validate:antiguedad_validacion_computed.immediate="'required'
                                                " name="antiguedad_validacion" data-vv-as=" ">
                                            <div slot="no-options">
                                                Seleccione 1
                                            </div>
                                        </v-select>
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <div class="mt-3">
                                            <vs-radio vs-name="tipoFinanciamiento" v-model="form.tipo_financiamiento
                                                " :vs-value="1" class="mr-4" :disabled="tiene_pagos_realizados ||
                                                    ventaLiquidada ||
                                                    fueCancelada
                                                    ">Uso inmediato</vs-radio>
                                            <vs-radio vs-name="tipoFinanciamiento" v-model="form.tipo_financiamiento
                                                " :vs-value="2" class="mr-4" :disabled="tiene_pagos_realizados ||
                                                    ventaLiquidada ||
                                                    fueCancelada
                                                    ">A futuro</vs-radio>
                                        </div>
                                    ...
                                    <div class="w-full px-2 size-small color-copy pt-2">
                                        <span class="font-medium uppercase" v-if="
                                            disponibilidad.disponibilidad_terreno ==
                                            1
                                        ">
                                            <span class="dot-success"></span>
                                            Propiedad disponible para
                                            venta</span>
                                        <span class="uppercase font-medium" v-else>
                                            <span class="dot-danger"></span>
                                            vendida a cliente (Titular):
                                            {{ disponibilidad.cliente }}
                                            <img class="cursor-pointer img-btn-28 mx-3" src="@assets/images/folder.svg"
                                                title="Expediente" @click="openReportes = true" /></span>
                                    </div>
                                    <div class="w-full px-2 size-small color-copy pt-2">
                                        <span class="color-danger-900 font-medium">Ojo:</span>
                                        Debe seleccionar la modalidad de la
                                        venta que se esté registrando en caso de
                                        que haya sido realizada fuera del
                                        control del sistema, ya que ese tipo de
                                        ventas cuenta con un control especial de
                                        números de órden.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group-content">
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full px-2 input-text">
                                        ...
                                        <v-select :options="vendedores" :clearable="false"
                                            :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="form.vendedor" class="w-full"
                                            v-validate:vendedor_validacion_computed.immediate="'required'
                                                " name="vendedor" data-vv-as=" " :disabled="fueCancelada">
                                            <div slot="no-options">
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <flat-pickr :disabled="tiene_pagos_realizados ||
                                            ventaLiquidada ||
                                            fueCancelada ||
                                            ModificarVenta
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <vs-input v-validate:solicitud_validacion_computed.immediate="'required'
                                            ...
                                            placeholder=" Núm. Solicitud" v-model="form.solicitud" :disabled="tipo_venta || fueCancelada
                                                " />
                                        <span>{{
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <vs-input v-validate:num_convenio_validacion_computed.immediate="'required'
                                            ...
                                            placeholder="Núm. Convenio" v-model="form.convenio" :disabled="!capturar_num_convenio ||
                                                fueCancelada
                                                " />
                                        <span>{{
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <vs-input v-validate:num_titulo_validacion_computed.immediate="'required'
                                            " name="num_titulo" data-vv-as=" " type="text" class="w-full"
                                            placeholder="Núm. Título" v-model="form.titulo" :disabled="!(
                                                tipo_venta *
                                                capturar_num_titulo +
                                                capturar_num_titulo
                                            ) || fueCancelada
                    ...
                    <div class="form-group-content">
                        <div class="flex flex-wrap">
                            <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                ...
                                <vs-input name="titular_sustituto" data-vv-as=" " data-vv-validate-on="blur"
                                    v-validate="'required'" maxlength="150" type="text" class="w-full"
                                    placeholder="Nombre del titular sustituto" v-model="form.titular_sustituto"
                            ...
                            <div class="w-full md:w-6/12 lg:w-4/12 xl:w-4/12 px-2 input-text">
                                ...
                                <vs-input name="parentesco_titular_sustituto" data-vv-as=" " data-vv-validate-on="blur"
                                    v-validate="'required'" maxlength="45" type="text" class="w-full"
                                    placeholder="Ej. Hermano" v-model="form.parentesco_titular_sustituto"
                                    :disabled="fueCancelada" />
                                <span>
                                    {{
                                        errors.first(
                            ...
                            <div class="w-full md:w-6/12 lg:w-4/12 xl:w-4/12 px-2 input-text">
                                ...
                                <vs-input name="telefono_titular_sustituto" data-vv-as=" " data-vv-validate-on="blur"
                                    v-validate="'required'" maxlength="45" type="text" class="w-full"
                                    placeholder="Ingrese un teléfono" v-model="form.telefono_titular_sustituto"
                                    :disabled="fueCancelada" />
                                <span>{{
                                    errors.first("telefono_titular_sustituto")
                                    }}</span>
                                <span v-if="
                                    this.errores.telefono_titular_sustituto
                                ">{{
                ...
                <div class="w-full text-right mt-6" v-if="!fueCancelada">
                    <span @click="agregar_beneficiario()" class="color-success-900 cursor-pointer">+ Agregar
                        beneficiarios</span>
                </div>
                <div class="form-group">
                    <div class="title-form-group">
                    ...
                    <div class="form-group-content">
                        <div v-if="form.beneficiarios.length > 0">
                            <div :key="index" v-for="(
beneficiario, index
                                ) in form.beneficiarios" class="flex flex-wrap">
                                <div class="w-full md:w-11/12">
                                    <div class="flex flex-wrap">
                                        <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                            ...
                                            <vs-input :name="'beneficiario' + index" data-vv-as=" "
                                                data-vv-validate-on="blur" v-validate="'required'" maxlength="75"
                                        ...
                                        <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                            ...
                                            <vs-input :name="'parentesco' + index" data-vv-as=" "
                                                data-vv-validate-on="blur" v-validate="'required'" maxlength="35"
                                                type="text" class="w-full" placeholder="Parentesco" v-model="beneficiario.parentesco
                                                    " />
                                            <span>{{
                                                errors.first(
                                                    "parentesco" + index
                                        ...
                                        <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                            ...
                                            <vs-input :name="'telefono' + index" maxlength="35" type="text"
                                                class="w-full" placeholder="Teléfono" v-model="beneficiario.telefono" />
                                        </div>
                                    </div>
                                </div>
                                <div class="w-full md:w-1/12 px-2">
                                    <div class="table h-full mx-auto mt-2">
                                        <span @click="remover_beneficiario(index)" v-if="!fueCancelada"
                                            class="color-danger-900 cursor-pointer table-cell align-middle">X
                                            remover</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div v-else class="px-2">
                            <div class="w-full px-2 size-base color-copy pt-2">
                                <span class="color-danger-900 font-medium">Ojo:</span>
                                No se han ingresado datos de los beneficiarios
                                de este contrato.
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full lg:w-6/12 px-2">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full md:w-6/12 px-2 input-text hidden">
                                        ...
                                        <vs-input size="large" v-validate="'required|integer|min_value:1|max_value:150'
                                            " name="salarios_minimos" data-vv-as=" " type="text" class="w-full"
                                            placeholder="Ingrese el número de salarios" v-model="form.salarios_minimos"
                                            maxlength="3" />
                                    ...
                                    <div class="w-full md:w-6/12 input-text px-2">
                                        ...
                                        <vs-input :disabled="tiene_pagos_realizados ||
                                            ...
                                            " size="large" name="tasa_iva" data-vv-as=" " v-validate="'required|decimal:2|min_value:0|max_value:25'
                                                " type="text" class="w-full" placeholder="Porcentaje IVA"
                                            v-model="form.tasa_iva" maxlength="2" />
                                    ...
                                    <div class="w-full input-text px-2">
                                        ...
                                        <vs-input :disabled="tiene_pagos_realizados ||
                                            ventaLiquidada ||
                                            fueCancelada
                                            " size="large" name="descuento" data-vv-as=" " v-validate="'required|decimal:2|min_value:0'
                                    ...
                                    <div class="w-full md:w-6/12 input-text px-2">
                                        ...
                                        <vs-input size="large" name="total_a_pagar" data-vv-as=" " v-validate="'required|decimal:2|min_value:0'
                                            " type="text" class="w-full" v-model="total_a_pagar_computed"
                                            :disabled="true" readonly />
                                        <span>{{
                                            errors.first("total_a_pagar")
                                            }}</span>
                                    </div>
                                    <div class="w-full md:w-6/12 input-text px-2">
                                        <label class="">
                                        ...
                                        <span v-if="this.errores.pago_inicial">{{ errores.pago_inicial[0] }}</span>
                                    </div>
                                    ...
                                    <div class="w-full input-text px-2">
                                        ...
                                        <vs-textarea :rows="4" ref="nota" type="text" class="w-full h-full"
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-wrap color-copy">
                                            <div class="w-full sm:w-6/12 px-2 text-left font-medium pb-2">
                                                Cliente
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 font-medium text-right pb-2">
                                                {{ form.cliente }}
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 text-left font-medium py-2">
                                                Ubicación
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 font-medium text-right py-2">
                                                <span v-if="this.datosAreas.id">
                                                    ...
                                                    ">
                                                        ...
                                                        <span v-else class="">Seleccione una
                                                            ubicación</span>
                                                    </span>
                                                    <span v-else>
                                                        <span v-if="
                                                ...
                                                <span v-else class="">Seleccione un Área del
                                                    Cementerio</span>
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 text-left font-medium py-2">
                                                Vendedor
                                            ...
                                            <div class="w-full sm:w-6/12 px-2 font-medium text-right py-2">
                                                ...
                                                <span v-else class="">Seleccione un
                                                    Vendedor</span>
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 text-left font-medium py-2">
                                                $ Costo neto
                                    ...
                                    <div class="w-full md:w-10/12 px-2 size-base color-copy pt-6 text-center mx-auto">
                                        <span class="color-danger-900 font-medium">Ojo:</span>
                                        Al hacer hacer click, se está actuando
                                        en representación del cliente para la
                                        compra de la propiedad que se ha
                                        seleccionado.
                                    </div>
                                    <div class="w-full px-2 pt-6 text-center mx-auto">
                                        <vs-button v-if="!fueCancelada" class="w-full md:w-10/12" @click="acceptAlert()"
                                            color="success">
                                            <span v-if="
        ...
        <ClientesBuscador v-if="openBuscador" :show="openBuscador" :z_index="'z-index58k'"
            @closeBuscador="openBuscador = false" @retornoCliente="clienteSeleccionado"></ClientesBuscador>
        <ReportesVentas v-if="openReportes" :z_index="'z-index58k'" :verAcuse="verAcuse" :show="openReportes"
            @closeListaReportes="closeListaReportes" :id_venta="id_venta_ver"></ReportesVentas>
    </div>
</template>
<script>
/**date picker */
...
export default {
    name: "formularioVentasCementerio",
    components: {
        "v-select": vSelect,
        flatPickr,
        Password,
        ...
        show: {
            ...
            async handler(newValue) {
                if (newValue) {
                    ...
                    this.$popupManager.register(this, this.cancelar, "fecha_venta");
                }
                ...
                if (this.datosAreas.tipo_propiedades_id == 4) {
                    ...
                    this.datosAreas["filas_columnas"].forEach((element) => {
                        ...
                        if (element.fila == this.form.filas.value) {
                            ...
                            for (
                                let index = 1;
                                index <= this.datosAreas.columnas;
                                index++
                            ) {
                    ...
                    if (this.getTipoformulario == "modificar") {
                        ...
                        if (this.datosVenta) {
                            this.lotes.forEach((element) => {
                                if (
                                    element.value ==
                                    this.datosVenta.venta_terreno.lote_raw
                                ) {
                ...
                if (this.getTipoformulario == "modificar") {
                    ...
                    if (this.datosVenta) {
                        this.filas.forEach((element) => {
                            if (
                                element.value ==
                                this.datosVenta.venta_terreno.fila_raw
                            ) {
    ...
    computed: {
        ...
        valor_minimo_pago_inicial: function () {
            ...
            if (this.form.financiamiento == 1) {
                ...
                pago_inicial_minimo = (
                    this.total_a_pagar_computed * 0.1
                ).toFixed(2);
            }
        ...
        valor_maximo_pago_inicial: function () {
            ...
            if (this.form.financiamiento == 1) {
                ...
                pago_inicial_maximo = (
                    this.total_a_pagar_computed * 0.7
                ).toFixed(2);
            }
    ...
    methods: {
        ...
        async get_disponibilidad() {
            try {
                ...
                if (res.data.data.length > 0) {
                    ...
                    this.disponibilidad.fecha_operacion =
                        res.data.data[0].fecha_operacion_texto;
        ...
        async consultar_venta_id() {
            try {
                this.$vs.loading();
                let res = await cementerio.consultar_venta_id(
                    this.form.id_venta
                );
                ...
                this.idAreaInicial =
                    this.datosVenta.venta_terreno.propiedades_id;
                /**se comienza a llenar la informacion de los datos */
                this.ventasAntiguedad.forEach((element) => {
                    if (
                        element.value == this.datosVenta.antiguedad_operacion_id
                    ) {
                ...
                this.vendedores.forEach((element) => {
                    if (
                        element.value ==
                        this.datosVenta.venta_terreno.vendedor.id
                    ) {
                ...
                this.form.tasa_iva =
                    Number(this.datosVenta.tasa_iva) <= 0
                        ? 16
                        : this.datosVenta.tasa_iva;
