<template>
    <div class="centerx">
            ...
            <div>
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-6/12 xl:w-6/12 px-4">
                        <!--mapa del cementerio-->
                        <div>
                            <Mapa :disabled="tiene_pagos_realizados || ventaLiquidada || fueCancelada
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        <label v-if="this.datosAreas.tipo_propiedades_id">
                                            <label v-if="this.datosAreas.tipo_propiedades_id == 4">Fila
                                                <span>(*)</span></label>
                                        ...
                                        <v-select :disabled="tiene_pagos_realizados || ventaLiquidada || fueCancelada
                                            " :options="filas" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="form.filas"
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <v-select :options="lotes" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                            v-model="form.lotes" :disabled="this.datosAreas.tipo_propiedades_id != 4 ||
                        ...
                        " :config="configdateTimePicker" v-model="form.fecha_venta" placeholder="Fecha de la Venta"
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <vs-input v-validate:solicitud_validacion_computed.immediate="'required'
                                            ...
                                            v-model="form.solicitud" :disabled="tipo_venta || fueCancelada" />
                                    ...
                                    <div class="w-full lg:w-6/12 xl:w-6/12 px-2 input-text">
                                        ...
                                        <vs-input v-validate:num_titulo_validacion_computed.immediate="'required'
                                            " name="num_titulo" data-vv-as=" " type="text" class="w-full" placeholder="Núm. Título"
                                            v-model="form.titulo" :disabled="!(
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-content">
                        <div v-if="form.beneficiarios.length > 0">
                            <div :key="index" v-for="(beneficiario, index) in form.beneficiarios"
                                ...
                                <div class="w-full md:w-11/12">
                                    <div class="flex flex-wrap">
                                        <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                            ...
                                            <span v-if="errores['beneficiarios.' + index + '.nombre']">{{
                                        ...
                                        <div class="w-full lg:w-4/12 xl:w-4/12 px-2 input-text">
                                            ...
                                            <vs-input :name="'parentesco' + index" data-vv-as=" "
                                                ...
                                                type="text" class="w-full" placeholder="Parentesco"
                                                v-model="beneficiario.parentesco" />
                                            <span>{{ errors.first("parentesco" + index) }}</span>
                                            <span v-if="errores['beneficiarios.' + index + '.parentesco']">
                                                {{
                                ...
                                <div class="w-full md:w-1/12 px-2">
                                    <div class="table h-full mx-auto mt-2">
                                        <span @click="remover_beneficiario(index)" v-if="!fueCancelada" class="
                        color-danger-900
                        cursor-pointer
                        table-cell
                        align-middle
                        ...
                        " name="financiamiento" data-vv-as=" " type="text" class="w-full" placeholder="Número de pagos"
                                    ...
                                    <div class="w-full md:w-6/12 input-text px-2">
                                        ...
                                        <vs-input :disabled="tiene_pagos_realizados || ventaLiquidada || fueCancelada
                                            ...
                                            v-validate="'required|decimal:2|min_value:0|max_value:25'" type="text"
                                            class="w-full" placeholder="Porcentaje IVA" v-model="form.tasa_iva"
                                            maxlength="2" />
                                    ...
                                    <div class="w-full md:w-6/12 input-text px-2">
                                        ...
                                        <vs-input size="large" name="total_a_pagar" data-vv-as=" "
                                            v-validate="'required|decimal:2|min_value:0'" type="text" class="w-full"
                                            v-model="total_a_pagar_computed" :disabled="true" readonly />
                        ...
                        ">
                                                <span v-if="this.datosAreas.id">
                                                    ...
                                                    ">
                                                        ...
                                                        <span v-else class="">Seleccione una ubicación</span>
                                                    </span>
                                                    <span v-else>
                                                        <span v-if="
                                                ...
                                                <span v-else class="">Seleccione un Área del Cementerio</span>
                                            </div>
                                            <div class="w-full sm:w-6/12 px-2 text-left font-medium py-2">
                                                Vendedor
                                            </div>
                    ...
                    ">
                                    ...
                                    <div class="w-full px-2 pt-6 text-center mx-auto">
                                        <vs-button v-if="!fueCancelada" class="w-full md:w-10/12" @click="acceptAlert()"
                                            color="success">
                                            <span v-if="this.getTipoformulario == 'agregar'">Guardar Venta</span>
        ...
        <ClientesBuscador :show="openBuscador" :z_index="'z-index58k'" @closeBuscador="openBuscador = false"
            @retornoCliente="clienteSeleccionado"></ClientesBuscador>
        <ReportesVentas :z_index="'z-index58k'" :verAcuse="verAcuse" :show="openReportes"
