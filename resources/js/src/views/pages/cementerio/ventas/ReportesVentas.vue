<template>
                        ...
                        <template>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span v-else
                                        >{{ programados.fecha_ultimo_pago_abr }}
                                    </span>
                                </vs-td>
    ...
    -->
                ...
                <div
                    class="w-full mt-6"
                    v-if="pagos_programados_cuotas.length > 0"
                >
                    <vs-table
                        class="tabla-datos"
    ...
    methods: {
        ...
        async consultar_venta_id() {
            ...
            try {
                ...
                this.$log("🚀 ~ this.datosVenta:", this.datosVenta);
