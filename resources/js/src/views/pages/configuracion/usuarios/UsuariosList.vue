                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full md:w-12/12 lg:w-4/12 xl:w-4/12 px-2">
                        <div class="w-full input-text">
                            ...
                            <v-select :options="rolesOptions" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'"
                                v-model="roles" class="w-full" />
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full sm:w-12/12 md:w-12/12 lg:w-6/12 xl:w-6/12 px-2">
                        <div class="w-full input-text">
                            ...
                            <vs-input class="w-full" icon="search" placeholder="Filtrar por nombre" v-model="nombre"
