                ...
                <div class="form-group-content">
                    <div class="flex flex-wrap">
                        <div class="w-full alerta pt-4 pb-6 px-2">
                            <div class="danger">
                                <h3>
                                    ¿Está seguro de querer cancelar este pago?
                                </h3>
                                <p>
                                    Una vez realizado el proceso de cancelación
                                    no habrá manera de volver a habilitar este
                                    pago. Es recomendable llevar a cabo este
                                    proceso una vez esté seguro de que es
                                    necesario.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-wrap">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <span
                                                                class="capitalize"
                                                                v-if="
                                                                    datosPago.tipo_operacion_texto
                                                                "
                                                                >{{
                                                                    datosPago.tipo_operacion_texto
                                                                }}</span
                                ...
                                <div class="w-full input-text px-2">
                                    <label
                                        ...
                                        cancelación de este movimiento:</label
                                    >
                                    <vs-textarea
                                        class="w-full"
            ...
            async handler(newValue) {
                if (newValue) {
                    ...
                    try {
                        ...
                        this.saldo_operacion =
                            this.datosPago.referencias_cubiertas[0].operacion_del_pago.saldo;
