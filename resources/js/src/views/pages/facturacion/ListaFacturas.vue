<template>
    <div>
        ...
        <div class="mt-5 vx-col w-full md:w-2/2 lg:w-2/2 xl:w-2/2">
            <vx-card no-radius title="Filtros de selección" refresh-content-action @refresh="reset"
                ...
                <div class="flex flex-wrap">
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-6/12 xl:w-6/12 mb-1 px-2 input-text">
                    ...
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-2/12 xl:w-2/12 px-2 input-text">
                    ...
                    <div class="w-full sm:w-12/12 md:w-6/12 lg:w-4/12 xl:w-4/12 px-2 input-text">
        ...
        <div id="resultados" class="mt-2 flex flex-col flex-1">
                    ...
                    <div class="">
                        <vs-table :sst="true" :max-items="serverOptions.per_page" :data="cfdis" stripe
                            ...
                            <template slot="header">
                                <h3>
                                    Lista de Artículos y Servicios por Lotes
                                </h3>
                            </template>
                            <template slot="thead">
                                <vs-th>Folio</vs-th>
                            ...
                            <template slot-scope="{ data }">
                                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data" :class="[
                                    tr.status == 0 ? 'text-danger' : '',
                                ]">
                                    ...
                                    <vs-td :data="data[indextr].id">
                                        ...
                                        <img width="25" class="cursor-pointer" src="@assets/images/cfdicog.svg" @click="
                                            openActions(data[indextr].id)
                                            " />
                                    </vs-td>
                                </vs-tr>
                            </template>
        ...
        <!--fin de buscador-->
        <FormularioCFDI v-if="verFormularioCFDI" :id_cfdi="id_cfdi" :tipo="TipodeFormulario" :show="verFormularioCFDI"
