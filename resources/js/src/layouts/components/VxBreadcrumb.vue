        ...
        <ul class="flex flex-wrap items-center">
            <li class="inline-flex items-end">
                ...
                <span class="breadcrumb-separator mx-2"><feather-icon
                        :icon="props.isRTL ? 'ChevronsLeftIcon' : 'ChevronsRightIcon'" svgClasses="w-4 h-4" /></span>
            </li>
            <li v-for="(link, index) in props.route.meta.breadcrumb.slice(1, -1)" :key="index"
            ...
            <li class="inline-flex">
                <span v-if="props.route.meta.breadcrumb.slice(-1)[0].active" class="cursor-default">{{
