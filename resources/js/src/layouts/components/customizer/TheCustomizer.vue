            ...
            <div class="h-full">
                ...
                >
                    <div class="px-6">
                        ...
                        <div>
                            ...
                            <ul class="clearfix">
                                ...
                                <li
                                    ...
                                    :class="{
                                        'shadow-outline': color == primaryColor,
                                    }"
                                ...
                                <li
                                    ...
                                    class="w-10 cursor-pointer h-10 rounded-lg m-2 float-left"
                                    @click="
                                        updatePrimaryColor(customPrimaryColor)
                                    "
                                />
                                <li class="float-left">
                                    <input
                        ...
                        <template v-if="layoutType === 'vertical'">
                            <div class="mt-4">
                                ...
                                <ul class="clearfix">
                                    ...
                                    <li
                                        :style="{
                                            backgroundColor: customNavbarColor,
                                        }"
                                        :class="
                                            navbarColorOptionClasses(
                                                navbarColorOptionClasses
                                        ...
                                        class="w-10 cursor-pointer h-10 rounded-lg m-2 float-left"
                                        @click="
                                            navbarColorLocal = customNavbarColor
                                        "
                                    />
                        ...
                        <div class="mt-4">
                            <h5 class="mb-2">
                                Router Animation {{ routerTransitionLocal }}
                            </h5>
                            <vs-select v-model="routerTransitionLocal">
                                <vs-select-item
                                    v-for="(
                                        item, index
                                    ) in routerTransitionsList"
                                    :key="index"
                                    :value="item.value"
                                    :text="item.text"
                                />
